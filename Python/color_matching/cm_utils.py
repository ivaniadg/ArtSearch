...
def save_data(data):
    with open('/home/mortirreke/Desktop/thesis/color_matching/output/colors.pickle', 'wb') as handle:
        pickle.dump(data, handle, protocol=pickle.HIGHEST_PROTOCOL)


def load_data():
    with open('/home/mortirreke/Desktop/thesis/color_matching/output/colors.pickle', 'rb') as handle:
